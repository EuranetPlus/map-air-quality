export const config = {
	mapTitle: 'map-air-quality', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-air-quality.vercel.app/', // The url provided when deploying the map on Vercel
